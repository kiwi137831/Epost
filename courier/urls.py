...
urlpatterns = [
 ...
 #   url(r'^CourierPickuplists/$', views.pickuplist, name='CourierPickUpLists'),
    ...
    path('<str:courier_id>/issue/<str:order_id>/', views.issue, name='issue'),
    path('<str:courier_id>/issue/<str:order_id>/issuereport/', views.issuereport, name='issuereport'),
   ...
   # url(r' CourierStoreParcels/storeinfo', views.storeinfo, name="storeinfo"),
    ...
    path('<str:courier_id>/noticeboard/', views.couriernotice, name ='couriernotice'),
]